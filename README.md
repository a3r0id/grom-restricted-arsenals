# Grom Restricted Arsenals (Alpha)
 A useful Arma 3 mod that allows mission-makers to initialize an infinite amount of whitelisted arsenals, restricted by player role and other attributes. 
